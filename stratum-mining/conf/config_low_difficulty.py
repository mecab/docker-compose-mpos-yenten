...
CENTRAL_WALLET = os.getenv('STRATUM_CENTRAL_WALLET')  # Local coin address where money goes

COINDAEMON_TRUSTED_HOST = os.getenv('STRATUM_COINDAEMON_TRUSTED_HOST')
COINDAEMON_TRUSTED_PORT = int(os.getenv('STRATUM_COINDAEMON_TRUSTED_PORT'))
COINDAEMON_TRUSTED_USER = os.getenv('STRATUM_COINDAEMON_TRUSTED_USER')
COINDAEMON_TRUSTED_PASSWORD = os.getenv('STRATUM_COINDAEMON_TRUSTED_PASSWORD')
...
LOGFILE = 'stratum2.log'      # eg. 'stratum.log'
LOGLEVEL = 'DEBUG'
...
HOSTNAME = os.getenv('WEB_ALIAS_DOMAIN')

# Disable the example service
ENABLE_EXAMPLE_SERVICE = False

# Port used for Socket transport. Use 'None' for disabling the transport.
LISTEN_SOCKET_TRANSPORT = int(os.getenv("STRATUM_SOCKET_PORT2"))
...
PASSWORD_SALT = os.getenv('STRATUM_PASSWORD_SALT')
...
# Postgresql
DB_PGSQL_HOST = 'db'
DB_PGSQL_DBNAME = 'postgres'
DB_PGSQL_USER = 'postgres'
DB_PGSQL_PASS = ''
DB_PGSQL_SCHEMA = 'public'
# MySQL
DB_MYSQL_HOST = 'db'
DB_MYSQL_DBNAME = os.getenv('MYSQL_DATABASE')
DB_MYSQL_USER = 'root'
DB_MYSQL_PASS = os.getenv('MYSQL_ROOT_PASSWORD')
...
INSTANCE_ID = 30                # Used for extranonce and needs to be 0-31
